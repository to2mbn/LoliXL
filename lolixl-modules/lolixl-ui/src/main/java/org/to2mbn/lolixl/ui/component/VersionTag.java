...
public class VersionTag {
	public static final VersionTag VANILLA_RELEASE = new VersionTag("game-version-tag-vanilla-release");
	public static final VersionTag VANILLA_SNAPSHOT = new VersionTag("game-version-tag-vanilla-snapshot");
	public static final VersionTag VANILLA_BETA = new VersionTag("game-version-tag-vanilla-beta");
